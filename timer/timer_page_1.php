     ...
     <section class="general" id="general">
             ...
             <div class="login_section container" id="r_log">
                  <form action="" method="post">
                     <p style="display: grid; grid-template-columns: 1fr 1fr 1fr; align-items: center;">   
                        ...
                        <?php
                                 try {
                                    $sql = "SELECT * FROM  ss1_timer_table";
        ...
        <div class="qb">
                <table>
                    ...
                    <?php
                        try {
                            $query2 ="SELECT * FROM ss1_timer_table";
...
<?php
    ...
    if (isset($_POST['createtimerdb'])) {
        create_database("ss1_timer_table");
    }
    ...
    if (isset($_POST['set_T'])) {
        ...
        $statement11 = "SHOW TABLES LIKE 'ss1_timer_table'";
        ...
        if ($subject == "----" || $time == "----") {
            ...
            if ($result1 -> num_rows >  0) {
               ...
               $checksid = "SELECT * FROM ss1_timer_table WHERE subjectt = '$subject'";
               ...
               if($result101->num_rows > 0){
                   ...
                   $subject = $_POST['subject'];
                   $time = $_POST['time'];
                   $statement22 = "INSERT INTO ss1_timer_table (subjectt,time) VALUES ('$subject','$time')";
               ...
               print  '<script>Swal.fire({
                   title: "RETRY AGAIN!",
                   text: "No Database Created For SSS1 Timer, Click On The Create Button On Top To Create The Database.",
                   icon: "error"
                 });</script>';
           }
    ...
    if (isset($_POST['delete'])) {
        $QID = $_POST['QID'];
        $statement1 = "DELETE FROM ss1_timer_table WHERE id = $QID ";
        $statement2 = "DELETE FROM ss1_timer_table WHERE id = $QID ";
