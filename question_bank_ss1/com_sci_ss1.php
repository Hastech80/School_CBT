...
<body>
    <section class="general" id="general">
        <section class="sec_general">
            ...
            <p>Senior Secondary School 1 {SSS1} Question Bank for  <span class="count" style="color:green; "> computer sci..</span></p><br>
            
            <div class="login_section container" id="r_log">
                 <form action="" method="post">
                    <p> Adding Questions ------------ <SPan style="color: red; " class="count">
                    <?php
                            $sql = "SELECT * FROM computer_sci_ss1";
    ...
    <div class="Q_UPLOADED container">
                ...
                <div class="qb">
                        <?php
                            $query2 ="SELECT * FROM computer_sci_ss1 ORDER BY id  ";
...
<?php
    if (isset($_POST['add'])) {
        ...
        if ($correct_A === '----') {
            ...
            $sql_add = "INSERT INTO computer_sci_ss1 (questions, opt_A, opt_B,opt_C,opt_D,correct_answer) VALUES ('$question','$optA','$optB','$optC','$optD','$correct_A')" ;
...
<?php
         if (isset($_POST['EDIT'])) {
            ...
            $sql1 = "UPDATE computer_sci_ss1 SET questions = '$question' ,opt_A = ' $A' , opt_B = ' $B', opt_C= ' $C', opt_D = ' $D'  WHERE id = '$sid'";
...
<?php
     if (isset($_POST['delete'])) {
        $sid = $_POST['QID'];
        $statement1 = "DELETE FROM computer_sci_ss1 WHERE id = $sid ";
        $statement2 = "DELETE FROM computer_sci_ss1 WHERE id = $sid ";
