<?php
            function create_database($table_name){
                ...
                try {
                    ...
                    $trigger_insert = "CREATE TRIGGER totalinsert BEFORE INSERT ON `$table_name` FOR EACH ROW SET
                                                                    NEW.total = (NEW.maths+
                                                                                NEW.eng+
                                                                                NEW.phy+
                                                                                NEW.chem+
                ...
                $trigger_update = "CREATE TRIGGER totalupdate BEFORE UPDATE ON `$table_name` FOR EACH ROW SET
                                                                    NEW.total = (NEW.maths+
                                                                                NEW.eng+
                                                                                NEW.phy+
                                                                                NEW.chem+
