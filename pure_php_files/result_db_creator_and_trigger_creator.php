<?php
            function create_database($table_name){
                ...
                try {
                    ...
                    $trigger_insert = "CREATE TRIGGER total_s_insert BEFORE INSERT ON `$table_name` FOR EACH ROW SET
                                                                    NEW.total = (NEW.maths+
                                                                                NEW.eng+
                                                                                NEW.phy+
                                                                                NEW.chem+
                ...
                $trigger_update = "CREATE TRIGGER total_s_update BEFORE UPDATE ON `$table_name` FOR EACH ROW SET
                                                                    NEW.total = (NEW.maths+
                                                                                NEW.eng+
                                                                                NEW.phy+
                                                                                NEW.chem+
