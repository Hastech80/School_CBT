...
<body>
    <?php 
        ...
        include "./header.php";
        include("./result_db_creator_and_trigger_creator2.php");
        ?>
    <h2>
        sss 2 result sheet [  this button should be clicked before the exam date ]. 
    ...
    <table>
        ...
        <?php   
                try {
                    $all = "SELECT * FROM result_ss2 ORDER BY TOTAL DESC LIMIT 1000 ";
...
<?php
    ...
    print  '<script>Swal.fire({
        title: "WELCOME!!!",
        text: "THIS IS SSS 2 RESULT PAGE",
        icon: "success"
      });</script>';
