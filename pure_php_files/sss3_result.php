...
<body>
    <?php 
        ...
        include "./header.php";
        include("./result_db_creator_and_trigger_creator3.php");
        ?>
    <h2>
        sss 3 result sheet [  this button should be clicked before the exam date ]. 
        <form action="" method="post">
            <input type="submit" value="create database" name="createdb" id="database">
            <input type="submit" value="sss 1 result" name="ss1" id="database">
    ...
    <table>
        <tr>
            ...
            <th class="spp"> <b style="color: green;">Total</b></th>
        </tr>
        <?php   
                try {
                    $all = "SELECT * FROM result_ss3 ORDER BY TOTAL DESC LIMIT 1000 ";
...
<?php
    print  '<script>Swal.fire({
        title: "WELCOME!!!",
        text: "THIS IS SSS 3 RESULT PAGE",
        icon: "success"
      });</script>';
